...
export const CURRENT_QUESTION_NUM = 0;
export const QUESTIONS_QTY = 0; // The total number of quiz questions (questions in the current round, if implemented)
export const CORRECT_ANSWERS_QTY = 0; // In the quiz (questions in the current round, if implemented)
